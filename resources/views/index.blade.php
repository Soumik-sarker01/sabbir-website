...
<style>
    ...
    .company-logos {
        ...
        overflow: hidden;
        z-index: 1;
        /* Lower stacking context for logos only */
    }
    ...
    .logos-overlay {
        ...
        bottom: 0;
        width: 350px;
        /* Your desired fade area width */
        pointer-events: none;
        z-index: 2;
        /* Lower than navbar/social icons */
    }

    .logos-overlay.left,
    .logos-overlay.right {
        width: 400px !important;
        /* Increased overlay width */
    }
    ...
    .logos-row {
        ...
        position: relative;
        padding: 10px 0;
        /* reduce vertical spacing within each row */
        opacity: 0;
        transform: translateY(50px);
    ...
    .logos-track img {
        width: 150px;
        /* smaller for less horizontal gap, adjust as needed */
        height: auto;
        margin: 0 15px;
        /* reduce horizontal gap between logos */
    }
...
================================ */
    ...
    .faq-answer.open {
        max-height: 500px;
        /* a large enough height to reveal text */
        opacity: 1;
    }
